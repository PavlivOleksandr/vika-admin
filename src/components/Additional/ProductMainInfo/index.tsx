  ...
  return (
    <Box justify='space-between'>
      ...
      <Box gap={12} width='auto'>
        <Text>
          <Text weight={theme.semiBoldFont}>Створено:</Text> {moment(createdAt).format('MM/DD/YY, HH:mm')}
        </Text>
        {createdAt !== updatedAt && (
          <Text>
            <Text weight={theme.semiBoldFont}>Оновлено:</Text> {moment(updatedAt).format('MM/DD/YY, HH:mm')}
          </Text>
        )}
      </Box>
    </Box>
